...
The application is deployed on Render and uses PostgreSQL, Prisma ORM, JWT authentication, Google Gemini AI, and Discord Webhooks.

Swagger documentation is publicly available through the deployed application.
